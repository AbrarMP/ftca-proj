...
short int* loadPPM3(const char *name, int &width, int& height)
 {
    ...
    in >> max;
    std::cout << max << "\n";
    pixel_t* data = (pixel_t*) malloc(width*height*sizeof(pixel_t));
...
//         canny_edge_detection(pixel_data, width, height, 45, 50, 1.5f);
//     if (out_data == NULL) {
//         fprintf(stderr, "main: failed canny_edge_detection.\n");
//         return 1;
//     }

//     savePPM3(out_data, width, height, "canny_out.ppm");
